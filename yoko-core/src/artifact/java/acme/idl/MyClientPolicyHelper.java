...
final public class MyClientPolicyHelper {
    ...
    public static MyClientPolicy extract(Any any) {
    ...
    public static MyClientPolicy read(InputStream in)
    {
        throw new MARSHAL();
    }

    @SuppressWarnings("unused")
    public static void write(OutputStream out, MyClientPolicy val)
    {
        throw new MARSHAL();
    }
